...
const ManageMyFoods = () => {
  ...
  return (
    <div className="relative p-4">
      ...
      <h3 className="text-center text-2xl md:text-3xl lg:text-4xl mb-4">
        Manage my Foods
      </h3>
      ...
      <div className="relative min-h-[300px] bg-base-100 rounded shadow p-2">
        {loading && (
          <div className="absolute inset-0 flex justify-center items-center bg-base-100/80 rounded">
        ...
        {!loading && foods.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {foods.map((food) => (
              <div
                key={food._id}
               className="card bg-base-100 border border-base-300 shadow-xl rounded-2xl overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-2xl"
 >
                <figure className="relative">
                  ...
                  />
                  <span className="absolute top-2 left-2 bg-primary text-primary-content text-xs font-semibold px-2 py-1 rounded">
                    {food.category}
                  </span>
                </figure>
                <div className="card-body p-4 space-y-1">
                  ...
                  <p className="text-sm text-base-content/70">
                    Expires:{" "}
                    <span className="font-semibold">{food.expiredDate}</span>
                  </p>
                  <p className="text-sm text-base-content/70">
                    Pickup:{" "}
                    <span className="font-semibold">{food.pickupLocation}</span>
                  </p>
