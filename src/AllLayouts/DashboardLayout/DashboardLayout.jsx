...
const DashboardLayout = () => {
  ...
  const isActive = (path) =>
    location.pathname === path || location.pathname === `/dashboard/${path}`;
    ...
    <>
      <div className="flex flex-col relative ">
        ...
        <main className="flex-1 ">
          <div className="flex flex-col min-h-[93vh] lg:flex-row gap-4 sm:gap-6 lg:gap-10 p-4 sm:p-6 lg:p-10 bg-base-200 rounded-2xl mb-6 lg:mb-10 text-base-content">
            {/* Sidebar */}
