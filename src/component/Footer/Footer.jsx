        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li><Link to="#" className="link link-hover">Features</Link></li>
              <li><Link to="#" className="link link-hover">Integrations</Link></li>
              <li><Link to="#" className="link link-hover">Pricing</Link></li>
              <li><Link to="#" className="link link-hover">FAQ</Link></li>
            </ul>
          </div>
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase font-bold">Company</h3>
            <ul className="space-y-1">
              <li><Link to="#" className="link link-hover">Privacy</Link></li>
              <li><Link to="#" className="link link-hover">Terms of Service</Link></li>
            </ul>
          </div>
          <div className="space-y-3">
            <h3 className="uppercase font-bold">Developers</h3>
            <ul className="space-y-1">
              <li><Link to="#" className="link link-hover">Public API</Link></li>
              <li><Link to="#" className="link link-hover">Documentation</Link></li>
              <li><Link to="#" className="link link-hover">Guides</Link></li>
            </ul>
          </div>
          <div className="space-y-3">
            <h3 className="uppercase font-bold">Social media</h3>
            <div className="flex space-x-3">
              <Link to="#" className="btn btn-sm btn-circle btn-primary">
